...
<template>
  <v-container fluid>
    ...
    <v-form class="my-4">
      <v-row>
        <v-col cols="12" md="6">
          <v-btn class="ma-4" color="success" @click="getCountries()">Interceptar Sin Error</v-btn>
          <v-btn color="error" @click="getCountries('Western Antarctica')">Interceptar Con Error</v-btn>
        </v-col>
      </v-row>
    </v-form>
    <v-alert
